...
type CacheInterface interface {
	GetMsg(sessionId string) []ChatMessage
	SetMsg(sessionId string, msg []ChatMessage)
	Clear(sessionId string)
}

var sessionServices *SessionService

func getLength(strPool []ChatMessage) int {
	var total int
...
func (s *SessionService) GetMsg(sessionId string) (msg []ChatMessage) {
...
func (s *SessionService) SetMsg(sessionId string, msg []ChatMessage) {
	maxLength := 4096
